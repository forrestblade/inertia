...
function makeTheme (): ThemeConfig {
  const lightColors = {
    ...
    'primary-text': 'oklch(0.6174 0.1790 319.1846)',
    ...
    'accent-text': 'oklch(0.8914 0.0371 294.1299)',
  ...
  const darkColors = {
    ...
    'primary-text': 'oklch(0.6805 0.1483 318.9453)',
    'primary-foreground': 'oklch(1.0000 0 0)',
    ...
    'accent-text': 'oklch(0.2647 0.0260 291.0590)',
